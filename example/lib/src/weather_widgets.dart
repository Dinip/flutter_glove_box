...
class WeatherForecast extends StatelessWidget {
  const WeatherForecast({List<Forecast> list = thisWeek, super.key}) : _list = list;
      ...
      child: Column(
        ...
        children: [
                ...
                child: Theme(
                  data: theme.copyWith(
                    ...
                    textTheme: theme.textTheme.copyWith(
                      bodyMedium: theme.textTheme.bodyMedium!.copyWith(fontSize: 24),
                    ),
                  ),
          ...
          Column(
            mainAxisSize: MainAxisSize.min,
            children: [
              Text('This Week\'s Forecast', style: Theme.of(context).textTheme.titleLarge),
