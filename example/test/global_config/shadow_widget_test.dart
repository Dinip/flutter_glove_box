...
void main() {
  ...
  GoldenToolkit.runWithConfiguration(
    () => {
      testGoldens('Shadows can be disabled locally by wrapping in GoldenToolkit.runWithConfiguration', (tester) async {
        await tester.pumpWidgetBuilder(const ShadowWidget());

        await screenMatchesGolden(tester, 'shadow_widget_locally_disabled_shadows');
      })
    },
